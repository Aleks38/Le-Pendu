...
<div class="container">
        <div class="row justify-content-center custom-line">
                    <div class="col-10 txtTitre fs-1">Le Pendu</div>
            </div>
...
<div class="col-6">
            <div class="  border-5 block">
                         ...
                         <a href="https://google.com"  class="btn success button "><span>Facile</span></a>
                         <a href="https://google.com"  class="btn warning button "><span>Moyen</span></a>
                         <a href="https://google.com"  class="btn danger button "><span>Difficile</span></a>
            ...
            <form action="" method="post" class="form-example">
                ...
                <div class="row justify-content-center">
                   ...
                   <!-- Première ligne du clavier virtuel -->
                    ...
                    <div class="col-1 px-0">
                        <input type="submit" name = "test" id="testE" value="e" class="btn marj " <?php if($_SESSION['lettres']['e'] == '1') echo "disabled" ; ?>>
                    </div>
                    <div class="col-1 px-0">
